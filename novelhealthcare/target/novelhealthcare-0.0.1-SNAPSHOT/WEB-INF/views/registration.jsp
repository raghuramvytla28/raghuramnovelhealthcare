			...
			<div class="col-md-6 col-md-offset-3">
				<div class="panel panel-login">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-lg-12">
								<form:form id="login-form" action="./reg"  commandName="manageUserProfileBean" method="GET" role="form" style="display: block;">
								<div class="form-group">
									...
									<div class="form-group">
										<form:input path="phoneNo" type="text"  id="phoneNo" tabindex="1" class="form-control" placeholder="phoneNo" value=""></form:input>
									</div>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-6 col-sm-offset-3">
												<input type="submit"  id="login-submit" tabindex="4" class="form-control btn btn-login" value="Signup">
											</div>
										</div>
									</div>
