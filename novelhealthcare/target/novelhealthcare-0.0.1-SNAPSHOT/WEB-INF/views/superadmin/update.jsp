...
<body>
	<div class="container">
		<div class="row">
			<div class="col-md-8">
				<section> <!--   <hr> --> <form:form action="./updateHospital" commandName="hospitalBean" method="POST" name="signup"
					...
					<div class="form-group">
						...
						<div class="form-group">
          <form:input path="hospitalId" type="hidden"  id="firstName" tabindex="1" class="form-control" placeholder="Hospital Name" 
          value="${hospBean.hospitalId}"/>
         </div>
					<div class="form-group">
						<label class="control-label col-sm-3">HospitalName <span class="text-danger">*</span></label>
