...
<div class="panel panel-primary">
		...
		<div class="panel-heading" st>Admin Management Board</div>
		<div class="col-md-6 col-sm-12 btn-margin-bottom action-buttons">
			<div class="btn-group" id="divAddNew">
				<a title="Add new" class="btn btn-block btn-danger btn-flat" href="./getAdminRegForm"><span class="hide-on-mobile">Add New </span><i
		...
		<div>
			<form action="./searchHospital">
				<select id="ddlFilter" class="ddlFilter form-control input-sm input-small input-inline" selectedindex="0" name="searchKey">
					...
					<option value="HospitalName">FirstName</option>
					<option value="Address1">LastName</option>
